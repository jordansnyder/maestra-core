-- =============================================================================
-- Maestra Demo Data Seed
-- 06-demo-data.sql
-- Runs after 05-analytics.sql. Seeds demo devices, entities, metrics, and events
-- for a realistic out-of-the-box dashboard experience.
...
-- 1. DEMO DEVICES
-- =============================================================================
-- Three fixed-UUID devices representing typical installation hardware.
...
-- 2. ENTITY TYPES
-- =============================================================================
-- Ensure the 5 types needed for demo entities exist.
-- 02-entities.sql seeds many types already; these use ON CONFLICT to be safe.
...
-- =============================================================================
-- Uses a DO block to look up entity_type_id dynamically (safe if types were
-- created by 02-entities.sql or by the INSERT above).
-- The path trigger in 02-entities.sql auto-computes LTREE paths from parent_id.
...
BEGIN
    ...
    -- Bail out if types are missing (should never happen after 02 + above INSERT)
...
-- =============================================================================
-- Guard: only insert if no demo metrics exist yet (idempotent).
...
BEGIN
    ...
    -- Temperature: sine-wave pattern 20-25C (period ~6h)
...
-- =============================================================================
-- Guard: only insert if no demo events exist yet.
...
DO $$
BEGIN
    RAISE NOTICE 'Maestra demo data seeded: 3 devices, 6 entities, 24h metrics, 20 events';
END $$;
