    ...
    return (
      <div className="min-h-full bg-gradient-to-br from-surface-0 to-surface-1 text-fg">
        <div className="container mx-auto px-6 py-8">
          <Link href="/streams" className="text-fg-muted hover:text-fg text-sm">
            Back to Streams
          </Link>
    ...
    <div className="min-h-full bg-gradient-to-br from-surface-0 to-surface-1 text-fg">
      <div className="container mx-auto px-6 py-8">
        ...
        <nav className="flex items-center gap-1.5 text-sm mb-6">
          ...
          <Link href="/streams" className="text-fg-muted hover:text-fg">
            Streams
          </Link>
          <ChevronRight className="w-3.5 h-3.5 text-fg-subtle" />
          <span className="text-fg">{stream.name}</span>
        </nav>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                <span className="text-sm px-2 py-0.5 bg-accent/20 text-accent rounded uppercase font-mono">
                  {stream.protocol}
                </span>
                ...
                <span className="text-xs text-fg-subtle font-mono">{stream.id}</span>
              </div>
            </div>
          </div>
        </header>
