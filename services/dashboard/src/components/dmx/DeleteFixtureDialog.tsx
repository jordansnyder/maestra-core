      ...
      <div className="modal-panel max-w-sm">
        <div className="flex items-center justify-between px-5 py-4 border-b border-edge">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-fg">Delete Fixture</h2>
          </div>
          <button onClick={onCancel} className="text-fg-subtle hover:text-fg transition-colors">
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="p-5 space-y-4">
          <p className="text-sm text-fg">
            Delete <span className="font-medium text-fg">{fixture.name}</span>? This removes it
            from the canvas and DMX patch.
          </p>

          {fixture.entity_id && (
            <label className="flex items-start gap-3 cursor-pointer select-none rounded-lg border border-edge px-3 py-2.5 hover:border-edge-strong transition-colors">
              <input
                type="checkbox"
              ...
              />
              <div>
                <div className="text-sm text-fg">Also delete the linked entity</div>
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              ...
              disabled={deleting}
              className="flex-1 px-4 py-2 rounded-lg text-sm font-medium bg-red-700 hover:bg-red-600 text-fg transition-colors disabled:opacity-50"
            >
