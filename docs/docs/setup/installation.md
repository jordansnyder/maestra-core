...
!!! tip "Are you an artist connecting to an existing Maestra?"
    You don't need to install anything on this page. Head to [Connect Your Tool](../connect/touchdesigner.md) instead — just pick your creative tool and follow the guide. This page is for **admins and technical directors** setting up a new Maestra instance.

This guide walks you through installing Maestra on your local machine or a server. By the end, you will have the full platform running and ready for your team to connect.
...
Open [http://localhost:3001](http://localhost:3001) in your browser. You should see the Maestra Dashboard with an empty device list, ready for connections.
...
## Sharing your Maestra with your team

Once Maestra is running, your team members can connect from their own machines using your computer's IP address. Find your local IP:
...
Give your team this address — they'll use it as the Maestra server address in their SDK setup (e.g., `http://192.168.1.10:8080`). Point them to the [Connect Your Tool](../connect/touchdesigner.md) section of these docs.
...
For a full list of environment variables, see [Configuration](configuration.md).

## What to Do Next

- **[Connect Your Tool](../connect/touchdesigner.md)** — pick your creative tool and start connecting
- **[Quick Start](quickstart.md)** — create your first entity and test the API
- **[Core Concepts](../concepts/entities.md)** — understand entities, state, and streams
