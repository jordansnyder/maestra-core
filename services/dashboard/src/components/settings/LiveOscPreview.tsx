...
export function LiveOscPreview({ oscAddress }: LiveOscPreviewProps) {
  ...
  return (
    <div className="bg-surface-0 border border-edge rounded-lg p-3">
      <div className="flex items-center gap-2 mb-2">
        <Activity className="w-3.5 h-3.5 text-fg-subtle" />
        <span className="text-xs font-medium text-fg-muted">Live Preview</span>
        <span className="text-[10px] font-mono text-fg-subtle ml-auto">{natsSubject}</span>
        <span
      ...
      {!connected ? (
        ...
        <div className="text-xs text-fg-subtle py-2">Waiting for messages...</div>
      ) : (
