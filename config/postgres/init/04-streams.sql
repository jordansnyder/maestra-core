...
CREATE INDEX idx_stream_subs_stream ON stream_subscribers(stream_id, time DESC);
CREATE INDEX idx_stream_subs_consumer ON stream_subscribers(consumer_id, time DESC);
CREATE INDEX idx_stream_subs_status ON stream_subscribers(status, time DESC);
